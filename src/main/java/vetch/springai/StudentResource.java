...
public class StudentResource {
	...
	public StudentResource(OllamaChatModel model, JdbcTemplate jdbc) {
		super();
		this.model = model;
		this.jdbc = jdbc;
	}

	public String processQuetsion(String question) {
		String prompt = """
				...
				""".formatted(question);
		ChatResponse res = model.call(new Prompt(prompt));
		String sql = cleanSql(res.getResult().getOutput().getText());
